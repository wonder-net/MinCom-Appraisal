...
The list of competencies — including which forms they appear on and their display order — is managed by HR Admin on the **Competencies** page. See [Managing Competencies](../04-hr-admin-guide/managing-competencies.md).
